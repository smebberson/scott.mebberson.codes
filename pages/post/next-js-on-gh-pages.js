...
export default withPostProps(({ post }) => (
    ...
    <Post post={ post }>
        ...
        <div className="constrained">
            ...
            <SyntaxHighlighter language="shell" style={ style }>{ `# Remove files from the out directory
$ rm -rf ./out/
...
` }</SyntaxHighlighter>
            ...
            <SyntaxHighlighter language="shell" style={ style }>{ `# Go back to master
$ git checkout master
...
` }</SyntaxHighlighter>
            ...
            <p>If you run <Inline>git branch</Inline> you should be on <Inline>master</Inline>. Now change into the <Inline>out</Inline> directory and run <Inline>git branch</Inline>, you should be on the <Inline>gh-pages</Inline> branch. So the <Inline>out</Inline> directory has been directly aliased to the <Inline>gh-pages</Inline> branch. That's kinda neat.</p>

            <p>Let's setup the out directory ready for <Inline>gh-pages</Inline>:</p>

            <SyntaxHighlighter language="shell" style={ style }>{ `# Add a .nojekyll file to out
touch ./out/.nojekyll
` }</SyntaxHighlighter>

            <p>With the hard part out of the way 😅, do the following every time you want to deploy a new version of your site:</p>

            <SyntaxHighlighter language="shell" style={ style }>{ `# Build and generate an export
$ yarn build
$ yarn export
...
` }</SyntaxHighlighter>
            ...
            <p>And hey presto, your Next.js site should be super zippy 🚀 on the GitHub Pages platform.</p>
